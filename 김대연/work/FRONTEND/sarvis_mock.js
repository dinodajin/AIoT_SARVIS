...
const SarvisApp = (() => {
    ...
    function initElements() {
        ...
        // 상태 표시 요소 (X, Y, Tilt, HAS)
        elements.statusX = document.getElementById('statusX');
        elements.statusY = document.getElementById('statusY');
        elements.statusTilt = document.getElementById('statusTilt');
        elements.statusHas = document.getElementById('statusHas');
    ...
    function bindEvents() {
        ...
        document.getElementById('btnTiltUp')?.addEventListener('click', () => 
            ManualController.moveTiltUp());
        document.getElementById('btnTiltDown')?.addEventListener('click', () => 
            ManualController.moveTiltDown());
        document.getElementById('btnHasLeft')?.addEventListener('click', () => 
            ManualController.moveHasLeft());
        document.getElementById('btnHasRight')?.addEventListener('click', () => 
            ManualController.moveHasRight());
